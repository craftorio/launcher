...
public class ImageUtils {
    public static BufferedImage genButton(int w, int h, BufferedImage img) {
        ...
        try {
            res.getGraphics().drawImage(fill(center, w - left.getWidth() - right.getWidth(), h), left.getWidth(), 0, w - left.getWidth() - right.getWidth(), h, null);
        } catch (Exception e) {
        }
    ...
    public static BufferedImage genPanel(int w, int h, BufferedImage img) {
        ...
        try {
            res.getGraphics().drawImage(fill(img.getSubimage(onew, 0, onew, oneh), w - onew * 2, oneh), onew, 0, w - onew * 2, oneh, null);
        } catch (Exception e) {
        }
        try {
            res.getGraphics().drawImage(fill(img.getSubimage(0, oneh, onew, oneh), onew, h - oneh * 2), 0, oneh, onew, h - oneh * 2, null);
        } catch (Exception e) {
        }
        try {
            res.getGraphics().drawImage(fill(img.getSubimage(onew, oneh * 2, onew, oneh), w - onew * 2, oneh), onew, h - oneh, w - onew * 2, oneh, null);
        } catch (Exception e) {
        }
        try {
            res.getGraphics().drawImage(fill(img.getSubimage(onew * 2, oneh, onew, oneh), onew, h - oneh * 2), w - onew, oneh, onew, h - oneh * 2, null);
        } catch (Exception e) {
        }
        try {
            res.getGraphics().drawImage(fill(img.getSubimage(onew, oneh, onew, oneh), w - onew * 2, h - oneh * 2), onew, oneh, w - onew * 2, h - oneh * 2, null);
        } catch (Exception e) {
        }
