...
public class LoginTheme
{
    ...
    public static ButtonStyle     loginBtn    = new ButtonStyle(48, 320, 127, 37, "font", "button1-craftorio", 14F, Color.decode("0xFFFFFF"), true, Align.CENTER);
    public static ButtonStyle     logoutBtn   = new ButtonStyle(48, 320, 127, 37, "font", "button2-craftorio", 14F, Color.decode("0xFFFFFF"), true, Align.CENTER);
    ...
    public static TextfieldStyle  login       = new TextfieldStyle(48, 220, 265, 32, "input-def-craftorio", "font", 14F, Color.decode("0xFFFFFF"), Color.decode("0xFFFFFF"), new EmptyBorder(0, 10, 0, 10));
    public static PassfieldStyle  password    = new PassfieldStyle(48, 269, 265, 32, "input-def-craftorio", "font", 14F, Color.decode("0xFFFFFF"), Color.decode("0xFFFFFF"), "1", new EmptyBorder(0, 10, 0, 10));
